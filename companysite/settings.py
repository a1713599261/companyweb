...
SECRET_KEY = 'django-insecure-*m1#di$5lvo%kjw$!))5-n_o(crrgxn=^=!-uwnw0#(g-^_#1y'
...
LOGGING = {
    ...
    'handlers': {  # 日志处理方法
        ...
        'file': {  # 向文件中输出日志
            ...
            'filename': os.path.join(BASE_DIR, "logs/company.log"),
            # 'filename': os.path.join(os.path.dirname(BASE_DIR), 'logs/company.log'),  # 日志文件的位置
